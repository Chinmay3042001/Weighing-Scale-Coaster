SamacSys ECAD Model
544776/893966/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "CAP1203-1-SN" (originalName "CAP1203-1-SN")
	...
	(compDef "CAP1203-1-SN" (originalName "CAP1203-1-SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "ALERT#") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "SMDAT") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "SMCLK") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "VDD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "CS1") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "CS2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "CS3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CAP1203-1-SN"))
		...
		(attr "Mouser Part Number" "579-CAP1203-1-SN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/CAP1203-1-SN?qs=ZEMkBHnybRFgBmrULrHmuQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "CAP1203-1-SN")
		(attr "Description" "CAP1203-1-SN Microchip Technology, CAP1203 Capacitive Touch Sensor Capacitive 8-Pin SOIC")
		(attr "Datasheet Link" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en566286")
		(attr "Height" "1.75 mm")
	)
