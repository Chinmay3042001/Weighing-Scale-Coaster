...
//1795702/893966/2.50/3/2/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "NX138AKR" (originalName "NX138AKR")
	...
	(compDef "NX138AKR" (originalName "NX138AKR") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NX138AKR"))
		...
		(attr "Mouser Part Number" "771-NX138AKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/NX138AKR?qs=1fQ7IOp4WrgZzhNlGoooaw%3D%3D")
		(attr "Manufacturer_Name" "Nexperia")
		(attr "Manufacturer_Part_Number" "NX138AKR")
		(attr "Description" "MOSFET 60V N-CH TENCH MOS")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/NX138AK.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NX138AKR.stp")
