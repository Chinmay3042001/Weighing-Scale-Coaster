...
//232671/1664033/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN74LVC1G04DCKR" (originalName "SN74LVC1G04DCKR")
	...
	(compDef "SN74LVC1G04DCKR" (originalName "SN74LVC1G04DCKR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN74LVC1G04DCKR"))
		...
		(attr "Manufacturer_Part_Number" "SN74LVC1G04DCKR")
		(attr "Description" "SN74LVC1G04 Single Inverter Gate")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/sn74lvc1g04.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "SN74LVC1G04DCKR.stp")
